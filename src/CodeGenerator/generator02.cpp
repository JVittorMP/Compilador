...
void getExpression(ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
...
void getCondition(ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
...
void generateCommands(ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
    for(auto nd : node->tokens) {
        ...
        if(cur->value == "System.out.println") {
            ...
            std::for_each(v.rbegin(), v.rend(), [&code](ast::Node02* id){
...
bool generateDeclarations(const ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
 ...
 */
bool generateSignature(const ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
...
bool generateReturn(const ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
...
void generateMain(ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
...
void generateMethod(ast::Node02* node, sem::scopeController & scope, cmd::Code & code) {
...
bool generate(ast::Node02* root) {
    sem::scopeController scope;
    cmd::Code code("../Documentos/code/code02.txt");
